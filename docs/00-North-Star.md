...
| Derived from | `source/XLent-Lessons-from-Supabase.txt`, `source/XLent-ModelOps.txt` |
| Authority | This document supersedes the source files for implementation decisions. |
